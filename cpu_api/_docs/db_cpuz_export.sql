...
DROP DATABASE IF EXISTS `db_cpuz`;
...
-- Listage de la structure de table db_cpuz. cpus
...
CREATE TABLE IF NOT EXISTS `cpus` (
  ...
  `frequence` decimal(10,1) NOT NULL,
  `prix` decimal(7,0) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=205 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Listage des données de la table db_cpuz.cpus : ~9 rows (environ)
INSERT INTO `cpus` (`id`, `marque`, `famille`, `modele`, `frequence`, `prix`) VALUES
