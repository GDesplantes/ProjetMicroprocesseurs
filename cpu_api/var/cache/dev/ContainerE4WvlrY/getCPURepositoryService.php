 ...
 */
class getCPURepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CPURepository' shared autowired service.
     *
     * @return \App\Repository\CPURepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CPURepository.php';

        return $container->privates['App\\Repository\\CPURepository'] = new \App\Repository\CPURepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
